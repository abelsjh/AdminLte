    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <?php if (isset($transaksiData) && count($transaksiData) > 0): ?>
                    <div class="card-body table-responsive p-0" style="height: 300px;">
                        <table class="table table-head-fixed text-nowrap">
                            ...
                            <tbody>
                                <?php
                                $nomor = 1;
                                foreach ($transaksiData as $user): ?>
                                    <tr>
                                        <td><?php echo $nomor++; ?></td>
                                        <td><?php echo $user['id_trans']; ?></td>
                                        <td><?php echo $user['kd_brg']; ?></td>
                                        <td><?php echo $user['id']; ?></td>
                                        <td><?php echo $user['jumlah']; ?></td>
                                        <td><?php echo $user['total_harga']; ?></td>
                                        <td><?php echo $user['tanggal']; ?></td>
                                        <td>
                                            <button type="button" class="btn btn-warning btn-sm"
                                                data-idtrans="<?php echo $user['id_trans']; ?>"
                                                data-kd="<?php echo $user['kd_brg']; ?>"
                                                data-id="<?php echo $user['id']; ?>"
                                                data-jumlah="<?php echo $user['jumlah']; ?>"
                                                data-totalharga="<?php echo $user['total_harga']; ?>"
                                                data-tanggal="<?php echo $user['tanggal']; ?>"
                ...
                <div class="modal-content bg-warning">
                    ...
                    <div class="modal-body">
                        <form id="editForm" method="POST" action="index.php?page=barang&action=updatebarang">
                            ...
                            <div class="mb-3">
                                <label for="editid_trans" class="form-label">ID Transaksi</label>
                                <input type="text" class="form-control" id="editid_trans" name="Trans" required>
                            </div>
                            <div class="mb-3">
                                <label for="editKd" class="form-label">Kode Barang</label>
                                <input type="text" class="form-control" id="editKd" name="kd" required>
                            </div>
                            <div class="mb-3">
                                <label for="editId" class="form-label">ID Pelanggan</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="editTotalHarga" name="totalharga" required>
                            </div>
                            <div class="mb-3">
